...
BaseColors::BaseColors() : IThemeLoadable(u8"Основные цвета") {
	...
	InitListWord({
		...
		u8"Рамка (активная)",
		u8"Название (фон)",
		u8"Название активное (фон)",
		u8"Название свёрнутое (фон)",
		u8"Строка меню (фон)",
		u8"Галочка (checkbox)",
		u8"Прокрутка (фон)",
		u8"Прокрутка (схваченная)",
		u8"Прокрутка (схваченная + выделенная)",
		u8"Прокрутка (схваченная + активная)",
		u8"Ползунок",
		u8"Ползунок (схваченный)",
		u8"Кнопка",
		u8"Кнопка (выделенная)",
		u8"Кнопка (активная)",
		u8"Заголовок",
		u8"Заголовок (выделенный)",
		u8"Заголовок (активный)",
		u8"Раздилитель",
		u8"Раздилитель (выделенный)",
		u8"Раздилитель (активный)",
		u8"Вкладка",
		u8"Вкладка (выделенная)",
		u8"Вкладка (выбранная)",
		u8"Полоска вкладки (выбранная)",
		u8"Затемнённая вкладка",
		u8"Затемнённая вкладка (выбранная)",
		u8"Затемнённая полоска вкладки (выбранная)",
		u8"Изменение размеров",
		u8"Изменение размеров (выделенная)",
		u8"Изменение размеров (активная)",
		u8"Заголовок таблицы (фон)",
		u8"Толстые границы таблицы",
		u8"Тонкие границы таблицы",
		u8"Фон нечётных строк таблицы",
		u8"Фон чётных строк таблицы",
		u8"Пространство",
		});
...
std::vector<NamedColor> BaseColors::GetDefaultDarkColors() {
	...
	std::vector<NamedColor> colors = {
		{u8"color.base.text",										ImColor(1.00f, 1.00f, 1.00f, 1.00f)},
		{u8"color.base.textLink",								ImColor(0.26f, 0.59f, 0.98f, 1.00f)},
		{u8"color.base.textDisabled",						ImColor(0.50f, 0.50f, 0.50f, 1.00f)},
		{u8"color.base.textSelectedBg",							ImColor(0.26f, 0.59f, 0.98f, 0.35f)},
		{u8"color.base.windowBg",								ImColor(0.06f, 0.06f, 0.06f, 0.94f)},
		{u8"color.base.childBg",						ImColor(0.00f, 0.00f, 0.00f, 0.00f)},
		{u8"color.base.popupBg",					ImColor(0.08f, 0.08f, 0.08f, 0.94f)},
		{u8"color.base.border",									ImColor(0.43f, 0.43f, 0.50f, 0.50f)},
